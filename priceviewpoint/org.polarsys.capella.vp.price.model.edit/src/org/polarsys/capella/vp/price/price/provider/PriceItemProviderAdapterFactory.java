...
import org.polarsys.capella.vp.price.price.util.PriceAdapterFactory;
 ...
 * @generated
 */
public class PriceItemProviderAdapterFactory extends PriceAdapterFactory
	...
	protected ChildCreationExtenderManager childCreationExtenderManager = new ChildCreationExtenderManager(
			PriceEditPlugin.INSTANCE, PricePackage.eNS_URI);
	 ...
	 * @generated
	 */
	public PriceItemProviderAdapterFactory() {
	...
	/**
	 * This keeps track of the one adapter used for all {@link org.polarsys.capella.vp.price.price.Price} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link org.polarsys.capella.vp.price.price.Price}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This keeps track of the one adapter used for all {@link org.polarsys.capella.vp.price.price.PartPrice} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected PartPriceItemProvider partPriceItemProvider;

	/**
	 * This creates an adapter for a {@link org.polarsys.capella.vp.price.price.PartPrice}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createPartPriceAdapter() {
		if (partPriceItemProvider == null) {
			partPriceItemProvider = new PartPriceItemProvider(this);
		}

		return partPriceItemProvider;
	}
	...
	public void dispose() {
		if (priceItemProvider != null)
			priceItemProvider.dispose();
		if (partPriceItemProvider != null)
			partPriceItemProvider.dispose();
	}
	...
	public static class EmdeChildCreationExtender implements
			...
			public Object caseExtensibleElement(ExtensibleElement object) {
				...
				if (ModelExtensionHelper.getInstance()
						.isExtensionModelDisabled(
								...
								"http://www.polarsys.org/capella/price")) { //$NON-NLS-1$
					return null;
				}
				// end-extension-code
				// begin-extension-code
		 ...
		 */
		public ResourceLocator getResourceLocator() {
			return PriceEditPlugin.INSTANCE;
		}
	}
			...
			public Object caseGenericPkg(GenericPkg object) {
				...
				// begin-extension-code
				{
					CommandParameter commandParameter = createChildParameter(
							...
							PriceFactory.eINSTANCE.createPrice());
					if (NewChildDescriptorHelper.isValidCommand(object,
							commandParameter)) {
						newChildDescriptors.add(commandParameter);
					}
