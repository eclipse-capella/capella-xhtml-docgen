 ...
 * @generated
 */
public class PartPriceItemProvider extends PriceItemProvider implements
	...
	protected void addCurrentPricePropertyDescriptor(Object object) {
		...
		itemPropertyDescriptors
				...
				(((ComposeableAdapterFactory) adapterFactory)
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_PartPrice_currentPrice_feature", "_UI_PartPrice_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						PricePackage.Literals.PART_PRICE__CURRENT_PRICE, true,
						false, false,
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/PartPrice")); //$NON-NLS-1$
	}
