...
public interface PricePackage extends EPackage {
	 ...
	 * @generated
	 */
	PricePackage eINSTANCE = org.polarsys.capella.vp.price.price.impl.PricePackageImpl.init();
	...
	interface Literals {
		 ...
		 * @generated
		 */
		EAttribute PART_PRICE__CURRENT_PRICE = eINSTANCE.getPartPrice_CurrentPrice();
