...
import org.polarsys.capella.vp.mass.mass.util.MassAdapterFactory;
 ...
 * @generated
 */
public class MassItemProviderAdapterFactory extends MassAdapterFactory
	...
	protected ChildCreationExtenderManager childCreationExtenderManager = new ChildCreationExtenderManager(
			MassEditPlugin.INSTANCE, MassPackage.eNS_URI);
	 ...
	 * @generated
	 */
	public MassItemProviderAdapterFactory() {
	...
	/**
	 * This keeps track of the one adapter used for all {@link org.polarsys.capella.vp.mass.mass.Mass} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This creates an adapter for a {@link org.polarsys.capella.vp.mass.mass.Mass}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	/**
	 * This keeps track of the one adapter used for all {@link org.polarsys.capella.vp.mass.mass.PartMass} instances.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected PartMassItemProvider partMassItemProvider;

	/**
	 * This creates an adapter for a {@link org.polarsys.capella.vp.mass.mass.PartMass}.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	...
	public Adapter createPartMassAdapter() {
		if (partMassItemProvider == null) {
			partMassItemProvider = new PartMassItemProvider(this);
		}

		return partMassItemProvider;
	}
	...
	public void dispose() {
		if (massItemProvider != null)
			massItemProvider.dispose();
		if (partMassItemProvider != null)
			partMassItemProvider.dispose();
	}
	...
	public static class EmdeChildCreationExtender implements IChildCreationExtender {
		...
		protected static class CreationSwitch extends EmdeSwitch<Object> {
			...
			public Object caseExtensibleElement(ExtensibleElement object) {
				...
				if (ModelExtensionHelper.getInstance(object).isExtensionModelDisabled(
						...
						"http://www.polarsys.org/capella/mass")) { //$NON-NLS-1$
					return null;
				}
				// end-extension-code
				// begin-extension-code
		 ...
		 */
		public ResourceLocator getResourceLocator() {
			return MassEditPlugin.INSTANCE;
		}
	}
			...
			public Object caseGenericPkg(GenericPkg object) {
				...
				// begin-extension-code
				{
					CommandParameter commandParameter = createChildParameter(
							...
							MassFactory.eINSTANCE.createMass());
					if (NewChildDescriptorHelper.isValidCommand(object, commandParameter)) {
						newChildDescriptors.add(commandParameter);
					}
				}
