...
public class MassSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		...
		case MassPackage.MASS: {
			...
			if (result == null)
				result = caseNamedElement(mass);
			if (result == null)
				result = caseAbstractNamedElement(mass);
			if (result == null)
				result = caseCapellaElement(mass);
			if (result == null)
				result = caseTraceableElement(mass);
			if (result == null)
				result = casePublishableElement(mass);
			if (result == null)
				result = caseModelElement(mass);
			if (result == null)
				result = caseExtensibleElement(mass);
			if (result == null)
				result = caseElement(mass);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
		case MassPackage.PART_MASS: {
			PartMass partMass = (PartMass) theEObject;
			T result = casePartMass(partMass);
			if (result == null)
				result = caseMass(partMass);
			if (result == null)
				result = caseElementExtension(partMass);
			if (result == null)
				result = caseNamedElement(partMass);
			if (result == null)
				result = caseAbstractNamedElement(partMass);
			if (result == null)
				result = caseCapellaElement(partMass);
			if (result == null)
				result = caseTraceableElement(partMass);
			if (result == null)
				result = casePublishableElement(partMass);
			if (result == null)
				result = caseModelElement(partMass);
			if (result == null)
				result = caseExtensibleElement(partMass);
			if (result == null)
				result = caseElement(partMass);
			if (result == null)
				result = defaultCase(theEObject);
			return result;
		}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Part Mass</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Part Mass</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T casePartMass(PartMass object) {
		return null;
	}
