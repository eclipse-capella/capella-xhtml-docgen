...
public class MassAdapterFactory extends AdapterFactoryImpl {
	 ...
	 * @generated
	 */
	protected MassSwitch<Adapter> modelSwitch = new MassSwitch<Adapter>() {
		@Override
		...
		@Override
		public Adapter casePartMass(PartMass object) {
			return createPartMassAdapter();
		}
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.capella.vp.mass.mass.Mass <em>Mass</em>}'.
	 * <!-- begin-user-doc -->
	...
	/**
	 * Creates a new adapter for an object of class '{@link org.polarsys.capella.vp.mass.mass.PartMass <em>Part Mass</em>}'.
	 * <!-- begin-user-doc -->
	 * This default implementation returns null so that we can easily ignore cases;
	 * it's useful to ignore a case when inheritance will catch all the cases anyway.
	 * <!-- end-user-doc -->
