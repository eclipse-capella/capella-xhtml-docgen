...
public class MassPackageImpl extends EPackageImpl implements MassPackage {
	...
	public static MassPackage init() {
		if (isInited)
			return (MassPackage) EPackage.Registry.INSTANCE
					.getEPackage(MassPackage.eNS_URI);

		// Obtain or create and register package
		MassPackageImpl theMassPackage = (MassPackageImpl) (EPackage.Registry.INSTANCE
				.get(eNS_URI) instanceof MassPackageImpl ? EPackage.Registry.INSTANCE
				.get(eNS_URI) : new MassPackageImpl());
	...
	public void initializePackageContents() {
		...
		massEClass.getESuperTypes()
				.add(theCapellacorePackage.getNamedElement());
		partMassEClass.getESuperTypes().add(this.getMass());
		partMassEClass.getESuperTypes().add(
		...
		initEClass(
				massEClass,
				Mass.class,
				"Mass", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(
				getMass_Value(),
				ecorePackage.getEInt(),
				"value", null, 0, 1, Mass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getMass_MaxValue(),
				ecorePackage.getEInt(),
				"maxValue", null, 0, 1, Mass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
		initEAttribute(
				getMass_MinValue(),
				ecorePackage.getEInt(),
				"minValue", null, 0, 1, Mass.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$

		initEClass(
				partMassEClass,
				PartMass.class,
				"PartMass", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS); //$NON-NLS-1$
		initEAttribute(
				getPartMass_CurrentMass(),
				ecorePackage.getEInt(),
				"currentMass", null, 0, 1, PartMass.class, IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED); //$NON-NLS-1$
