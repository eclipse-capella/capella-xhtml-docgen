 ...
 * @generated
 */
public class MassItemProvider extends NamedElementItemProvider implements
	...
	protected void addValuePropertyDescriptor(Object object) {
		...
		itemPropertyDescriptors
				...
				(((ComposeableAdapterFactory) adapterFactory)
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_Mass_value_feature", "_UI_Mass_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
	...
	protected void addMaxValuePropertyDescriptor(Object object) {
		...
		itemPropertyDescriptors
				...
				(((ComposeableAdapterFactory) adapterFactory)
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_Mass_maxValue_feature", "_UI_Mass_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						MassPackage.Literals.MASS__MAX_VALUE, true, false,
	...
	protected void addMinValuePropertyDescriptor(Object object) {
		...
		itemPropertyDescriptors
				...
				(((ComposeableAdapterFactory) adapterFactory)
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_Mass_minValue_feature", "_UI_Mass_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						MassPackage.Literals.MASS__MIN_VALUE, true, false,
						false, ItemPropertyDescriptor.INTEGRAL_VALUE_IMAGE,
						null,
						// begin-extension-code
						null));
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/Mass")); //$NON-NLS-1$
	}
	...
	protected void collectNewChildDescriptors(
		...
		// begin-extension-code
		{
			CommandParameter commandParameter = createChildParameter(
					...
					MassFactory.eINSTANCE.createPartMass());
