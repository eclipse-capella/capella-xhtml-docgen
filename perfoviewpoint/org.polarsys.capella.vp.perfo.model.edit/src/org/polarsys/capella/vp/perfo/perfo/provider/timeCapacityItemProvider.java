 ...
 * @generated
 */
public class timeCapacityItemProvider extends PerformanceCapacityItemProvider
	...
	protected void addCurrentExecutionTimePropertyDescriptor(Object object) {
		...
		itemPropertyDescriptors
				...
				(((ComposeableAdapterFactory) adapterFactory)
						...
						getString(
								"_UI_PropertyDescriptor_description", "_UI_timeCapacity_currentExecutionTime_feature", "_UI_timeCapacity_type"), //$NON-NLS-1$ //$NON-NLS-2$ //$NON-NLS-3$
						PerfoPackage.Literals.TIME_CAPACITY__CURRENT_EXECUTION_TIME,
						true, false, false,
	...
	public Object getImage(Object object) {
		return overlayImage(object,
				getResourceLocator().getImage("full/obj16/timeCapacity")); //$NON-NLS-1$
	}
