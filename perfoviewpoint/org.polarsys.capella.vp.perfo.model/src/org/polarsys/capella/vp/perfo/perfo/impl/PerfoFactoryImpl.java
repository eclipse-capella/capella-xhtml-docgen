...
public class PerfoFactoryImpl extends EFactoryImpl implements PerfoFactory {
	...
	public static PerfoFactory init() {
		try {
			PerfoFactory thePerfoFactory = (PerfoFactory) EPackage.Registry.INSTANCE
					.getEFactory("http://www.polarsys.org/capella/perfo"); //$NON-NLS-1$ 
	 ...
	 * @generated
	 */
	public measurementUnit_Type createmeasurementUnit_TypeFromString(
	 ...
	 * @generated
	 */
	public String convertmeasurementUnit_TypeToString(EDataType eDataType,
