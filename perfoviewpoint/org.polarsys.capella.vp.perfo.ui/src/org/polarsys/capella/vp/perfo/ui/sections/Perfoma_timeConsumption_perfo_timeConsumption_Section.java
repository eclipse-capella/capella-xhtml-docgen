...
public class Perfoma_timeConsumption_perfo_timeConsumption_Section extends
		AbstractSection {
	...
	public void createControls(Composite parent,
		...
		perfo_timeConsumption_AttributeGroup = getWidgetFactory().createGroup(
				_rootParentComposite, "Time Consumption Attributes");
		perfo_timeConsumption_AttributeGroup
				.setLayout(new GridLayout(1, false));
		GridData gdperfo_timeConsumption_AttributeGroup = new GridData(
				GridData.FILL_HORIZONTAL);
		gdperfo_timeConsumption_AttributeGroup.horizontalSpan = ((GridLayout) _rootParentComposite
				.getLayout()).numColumns;
		perfo_timeConsumption_AttributeGroup
				.setLayoutData(gdperfo_timeConsumption_AttributeGroup);

		ValueField = new TextValueGroup(perfo_timeConsumption_AttributeGroup,
				"Execution Time :", getWidgetFactory(), true);
