...
public class OpenActionService {
	 ...
	 * @generated NOT
	 */
	public boolean CreateLABFunctionTimeConsumption(EObject element,
			EObject newSemanticContainer) {
		if (element instanceof AbstractFunction
				&& checktimeConsumptionUnicity(((AbstractFunction) element)
						.getOwnedExtensions())) {
			AbstractFunction functionalExchange = (AbstractFunction) element;
			timeConsumption timeConsumption = PerfoFactory.eINSTANCE
					.createtimeConsumption();
		...
		if (element instanceof FunctionalExchange
				&& checktimeConsumptionUnicity(((FunctionalExchange) element)
						.getOwnedExtensions())) {
	 ...
	 * @generated NOT
	 */
	public boolean createFunctionalCapacity(EObject element,
			EObject newSemanticContainer) {
		if (element instanceof FunctionalChain
				&& checktimeCapacityUnicity(((FunctionalChain) element)
						.getOwnedExtensions())) {
			FunctionalChain functionalChain = (FunctionalChain) element;
			timeCapacity timeCapacity = PerfoFactory.eINSTANCE
					.createtimeCapacity();
	...
	private boolean checktimeConsumptionUnicity(
			EList<ElementExtension> extensions) {
