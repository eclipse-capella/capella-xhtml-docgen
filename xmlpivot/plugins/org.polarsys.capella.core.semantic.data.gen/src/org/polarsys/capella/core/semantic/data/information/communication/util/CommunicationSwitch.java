...
public class CommunicationSwitch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case CommunicationPackage.EXCEPTION: {
				org.polarsys.capella.core.semantic.data.information.communication.Exception exception = (org.polarsys.capella.core.semantic.data.information.communication.Exception)theEObject;
	 ...
	 * @generated
	 */
	public T caseException(org.polarsys.capella.core.semantic.data.information.communication.Exception object) {
		return null;
	}
