 ...
 * <ul>
 *   <li>{@link org.polarsys.capella.core.semantic.data.capellacore.impl.TypedElementImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public abstract class TypedElementImpl extends NamedElementImpl implements TypedElement {
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, CapellacorePackage.TYPED_ELEMENT__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(Type newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, CapellacorePackage.TYPED_ELEMENT__TYPE, oldType, type));
	}
