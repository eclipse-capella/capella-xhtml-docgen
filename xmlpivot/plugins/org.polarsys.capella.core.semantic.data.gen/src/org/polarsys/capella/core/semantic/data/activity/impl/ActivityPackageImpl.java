...
import org.polarsys.capella.core.semantic.data.activity.ActivityFactory;
...
public class ActivityPackageImpl extends EPackageImpl implements ActivityPackage {
	 ...
	 * @see org.polarsys.capella.core.semantic.data.activity.ActivityPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		activityEdgeEClass.getESuperTypes().add(theModellingcorePackage.getModelElement());
		...
		activityPartitionEClass.getESuperTypes().add(theModellingcorePackage.getModelElement());
		...
		abstractActionEClass.getESuperTypes().add(this.getActivityNode());
		...
		objectNodeEClass.getESuperTypes().add(theModellingcorePackage.getAbstractNamedElement());
	...
	protected void createXmlpivotAnnotations() {
		...
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
			 "sourceNsURI", "http://www.polarsys.org/capella/common/activity/0.8.0"
		   });
	}
