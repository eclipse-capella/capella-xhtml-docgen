...
import org.polarsys.capella.core.semantic.data.pa.deployment.DeploymentFactory;
...
public class DeploymentPackageImpl extends EPackageImpl implements DeploymentPackage {
	 ...
	 * @see org.polarsys.capella.core.semantic.data.pa.deployment.DeploymentPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		initEReference(getPortInstance_Connections(), this.getConnectionInstance(), null, "connections", null, 0, -1, PortInstance.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
	...
	protected void createXmlpivotAnnotations() {
		...
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
			 "sourceNsURI", "http://www.polarsys.org/capella/core/pa/deployment/0.8.0"
		   });
	}
