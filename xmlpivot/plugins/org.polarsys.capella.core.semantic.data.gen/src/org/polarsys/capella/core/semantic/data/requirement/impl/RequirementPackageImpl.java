...
import org.polarsys.capella.core.semantic.data.requirement.RequirementFactory;
...
public class RequirementPackageImpl extends EPackageImpl implements RequirementPackage {
	 ...
	 * @see org.polarsys.capella.core.semantic.data.requirement.RequirementPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		requirementsTraceEClass.getESuperTypes().add(theCapellacorePackage.getCapellaElement());
		requirementsTraceEClass.getESuperTypes().add(theModellingcorePackage.getTraceableElement());
		requirementsTraceEClass.getESuperTypes().add(theModellingcorePackage.getModelElement());
	...
	protected void createXmlpivotAnnotations() {
		...
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
			 "sourceNsURI", "http://www.polarsys.org/capella/core/requirement/0.8.0"
		   });
	}
