 ...
 * <ul>
 *   <li>{@link org.polarsys.capella.core.semantic.data.capellacommon.impl.StateTransitionImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link org.polarsys.capella.core.semantic.data.capellacommon.impl.StateTransitionImpl#getTriggerDescription <em>Trigger Description</em>}</li>
 *   <li>{@link org.polarsys.capella.core.semantic.data.capellacommon.impl.StateTransitionImpl#getGuard <em>Guard</em>}</li>
 *   <li>{@link org.polarsys.capella.core.semantic.data.capellacommon.impl.StateTransitionImpl#getSource <em>Source</em>}</li>
 *   <li>{@link org.polarsys.capella.core.semantic.data.capellacommon.impl.StateTransitionImpl#getTarget <em>Target</em>}</li>
 *   <li>{@link org.polarsys.capella.core.semantic.data.capellacommon.impl.StateTransitionImpl#getEffect <em>Effect</em>}</li>
 *   <li>{@link org.polarsys.capella.core.semantic.data.capellacommon.impl.StateTransitionImpl#getTriggers <em>Triggers</em>}</li>
 *   <li>{@link org.polarsys.capella.core.semantic.data.capellacommon.impl.StateTransitionImpl#getRealizedStateTransitions <em>Realized State Transitions</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class StateTransitionImpl extends NamedElementImpl implements StateTransition {
	...
	/**
	 * The cached value of the '{@link #getRealizedStateTransitions() <em>Realized State Transitions</em>}' reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getRealizedStateTransitions()
	 * @generated
	 * @ordered
	 */
	protected EList<StateTransition> realizedStateTransitions;
	...
	public EList<StateTransition> getRealizedStateTransitions() {
		if (realizedStateTransitions == null) {
			realizedStateTransitions = new EObjectEList<StateTransition>(StateTransition.class, this, CapellacommonPackage.STATE_TRANSITION__REALIZED_STATE_TRANSITIONS);
		}
		return realizedStateTransitions;
	}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case CapellacommonPackage.STATE_TRANSITION__TRIGGERS:
				...
				return;
			case CapellacommonPackage.STATE_TRANSITION__REALIZED_STATE_TRANSITIONS:
				getRealizedStateTransitions().clear();
				getRealizedStateTransitions().addAll((Collection<? extends StateTransition>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case CapellacommonPackage.STATE_TRANSITION__REALIZED_STATE_TRANSITIONS:
				return realizedStateTransitions != null && !realizedStateTransitions.isEmpty();
		}
