...
import org.polarsys.capella.core.semantic.data.sharedmodel.SharedmodelFactory;
...
public class SharedmodelPackageImpl extends EPackageImpl implements SharedmodelPackage {
	 ...
	 * @see org.polarsys.capella.core.semantic.data.sharedmodel.SharedmodelPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void initializePackageContents() {
		...
		sharedPkgEClass.getESuperTypes().add(theCapellacorePackage.getStructure());
	...
	protected void createXmlpivotAnnotations() {
		...
		addAnnotation
		  (this, 
		   source, 
		   new String[] {
			 "sourceNsURI", "http://www.polarsys.org/capella/core/sharedmodel/0.8.0"
		   });
	}
