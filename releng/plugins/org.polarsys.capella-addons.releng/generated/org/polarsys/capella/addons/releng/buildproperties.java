...
public class buildproperties extends org.eclipse.egf.portfolio.eclipse.build.buckminster.buildproperties {
	...
	protected final String TEXT_1 = NL + "#site servers" + NL + "eclipse.download.prefix=http://download.eclipse.org" + NL
			...
			+ "director.url=${eclipse.download.prefix}/tools/buckminster/products/director_latest.zip" + NL + "" + NL + "#buckminster installation" + NL
			+ "buckminster.release=4.2" + NL + "bm.headless.site=${eclipse.download.prefix}/tools/buckminster/headless-${buckminster.release}" + NL
