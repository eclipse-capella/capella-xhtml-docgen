...
public class rmaplocaladdcomthalesgroupmde extends org.eclipse.egf.portfolio.eclipse.build.buckminster.additions.buildrmaplocal {
	protected static String nl;

	public static synchronized rmaplocaladdcomthalesgroupmde create(String lineSeparator) {
		nl = lineSeparator;
		rmaplocaladdcomthalesgroupmde result = new rmaplocaladdcomthalesgroupmde();
		nl = null;
		return result;
	}
	...
	protected final String TEXT_4 = "\">" + NL + "\t\t<provider componentTypes=\"eclipse.feature,osgi.bundle\" readerType=\"url.catalog\" mutable=\"true\" source=\"true\">" + NL
			+ "\t\t\t<uri format=\"file:/";
	protected final String TEXT_5 = "/{0}";
	protected final String TEXT_6 = "\">" + NL + "\t\t\t\t<bc:propertyRef key=\"buckminster.component\" />" + NL + "\t\t\t</uri>" + NL + "\t\t</provider>" + NL + "" + NL
			+ "\t\t<provider componentTypes=\"eclipse.feature,osgi.bundle\" readerType=\"url.catalog\" mutable=\"true\" source=\"true\">" + NL + "\t\t\t<uri format=\"file:/";
	protected final String TEXT_7 = "/{0}";
	protected final String TEXT_8 = "\">" + NL + "\t\t\t\t<bc:replace>" + NL + "\t\t\t\t\t<bc:propertyRef key=\"buckminster.component\" />" + NL
			+ "\t\t\t\t\t<bc:match pattern=\"^com\\.thalesgroup\\.mde\\.(.*)$\" replacement=\"$1\" />" + NL + "\t\t\t\t</bc:replace>" + NL + "\t\t\t</uri>" + NL
			+ "\t\t</provider>" + NL + "\t</searchPath>" + NL + "\t";
	protected final String TEXT_9 = NL;
	protected final String TEXT_10 = NL;

	public rmaplocaladdcomthalesgroupmde() {
