...
public class buildxmlpublishStepfeature
		extends org.eclipse.egf.portfolio.eclipse.build.buckminster.additions.buildxmlpublishStepfeature {
	...
	protected final String TEXT_3 = NL + "             " + NL + "             <echo message=\"Generate Site\"/>" + NL
			+ "             <buckminster command=\"perform\">" + NL + "                    <globargs>" + NL
			+ "                          <arg value=\"-Dsite.include.top=true\"/>" + NL
			+ "                          <arg value=\"-Dsite.signing=";
	protected final String TEXT_4 = "\"/>                      " + NL
			+ "                          <arg value=\"-Dcbi.include.source=";
	protected final String TEXT_5 = "\"/>                      " + NL + "                    </globargs>" + NL
			+ "                    <cmdargs>" + NL + "                          <arg value=\"";
	protected final String TEXT_6 = ":eclipse.feature#site.p2\" />" + NL + "                    </cmdargs>" + NL
			+ "             </buckminster>" + NL + "" + NL + "             <echo message=\"Publish site\"/>" + NL
			+ "             <mkdir dir=\"";
	protected final String TEXT_7 = "/site.p2/\"/>" + NL + "             <copy todir=\"";
	protected final String TEXT_8 = "/site.p2/\">" + NL + "                    <fileset dir=\"${result}/output\">" + NL
			+ "                          <include name=\"";
	protected final String TEXT_9 = "*/site.p2/*\"/>" + NL + "                          <include name=\"";
	protected final String TEXT_10 = "*/site.p2/**\"/>" + NL + "                    </fileset>" + NL
			+ "                    <filtermapper>" + NL
			+ "                          <replaceregex pattern=\".*site\\.p2\" replace=\"\" />" + NL
			+ "                    </filtermapper>" + NL + "             </copy>" + NL;
	protected final String TEXT_11 = NL + "             <echo message=\"Publish dropins\"/>" + NL
			+ "             <condition property=\"site.src\" value=\"site.signed\" else=\"site\">" + NL
			+ "                    <istrue value=\"${site.signing}\" />" + NL + "             </condition>" + NL + ""
			+ NL + "             <copy todir=\"";
	protected final String TEXT_12 = "/dropins/";
	protected final String TEXT_13 = "/eclipse/\">" + NL + "                    <fileset dir=\"${result}/output\">" + NL
			+ "                          <include name=\"";
	protected final String TEXT_14 = "*/${site.src}/plugins/*.jar\"/>" + NL
			+ "                          <include name=\"";
	protected final String TEXT_15 = "*/${site.src}/features/*.jar\"/>" + NL + "                    </fileset>" + NL
			+ "                    <filtermapper>" + NL
			...
			+ NL + "                    </filtermapper>" + NL + "             </copy>" + NL + "" + NL
			+ "             <buckminster command=\"perform\">" + NL + "                    <globargs>" + NL
			+ "                          <arg value=\"-DsiteDir=";
	protected final String TEXT_16 = "/dropins/";
	protected final String TEXT_17 = "/eclipse/\" />" + NL + "                    </globargs>" + NL
			+ "                    <cmdargs>";
	protected final String TEXT_18 = "                    " + NL + "                          <arg value=\"";
	protected final String TEXT_19 = ":buckminster#convertSiteToRuntime\" />" + NL + "                    </cmdargs>"
			+ NL + "             </buckminster>" + NL + "             " + NL
			+ "             <pathconvert property=\"featurefile";
	protected final String TEXT_20 = "\">" + NL + "                    <first count=\"1\">" + NL
			+ "                          <fileset dir=\"${result}/output\" includes=\"";
	protected final String TEXT_21 = "*eclipse.feature/temp/manifest/feature.xml\" />" + NL
			+ "                    </first>" + NL + "             </pathconvert>" + NL
			+ "             <loadfile property=\"featureversion";
	protected final String TEXT_22 = "\" srcFile=\"${featurefile";
	protected final String TEXT_23 = "}\">" + NL + "                    <filterchain>" + NL
			+ "                          <striplinebreaks/>" + NL + "                          <replaceregex" + NL
			+ "                                 pattern=\"^.*&lt;feature[^&gt;]*version=&quot;([^&quot;]*)&quot;.*$\""
			+ NL + "                                 replace=\"\\1\"/>" + NL + "                    </filterchain>" + NL
			+ "             </loadfile>" + NL + "" + NL + "             <touch file=\"";
