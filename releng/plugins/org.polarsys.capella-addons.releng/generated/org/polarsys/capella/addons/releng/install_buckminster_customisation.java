//Generated with EGF 1.2.0.v20150210-2141
...
public class install_buckminster_customisation extends org.eclipse.egf.portfolio.eclipse.build.buckminster.buildxml {
	protected static String nl;

	public static synchronized install_buckminster_customisation create(String lineSeparator) {
		nl = lineSeparator;
	...
	protected final String TEXT_1 = "    <target name=\"install.buckminster\">" + NL
			...
			+ "                <arg value=\"org.eclipse.buckminster.pde.headless.feature.feature.group\" />" + NL + "            </args>" + NL + "        </eclipse.launch>" + NL
			+ "    </target>" + NL + "    ";
