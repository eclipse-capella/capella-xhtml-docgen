...
public class AbstractFunction_InvolvingOperationalProcesses {
	protected static String nl;

	public static synchronized AbstractFunction_InvolvingOperationalProcesses create(String lineSeparator) {
		nl = lineSeparator;
		AbstractFunction_InvolvingOperationalProcesses result = new AbstractFunction_InvolvingOperationalProcesses();
		nl = null;
		return result;
	}
	...
	public AbstractFunction_InvolvingOperationalProcesses() {
	...
	protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		Collection<String> involvingFunctionalChains = FunctionHelper.getInvolvingFunctionalChains(projectNameParameter,
				outputFolderParameter, parameter);
		if (involvingFunctionalChains.size() > 0) {
			String title = "Involving Operational Processes";
			Integer level = 2;

			stringBuffer.append(TEXT_1);
			{
				//<%@ egf:patternCall patternId="platform:/plugin/org.polarsys.capella.docgen/egf/HTMLDocGenCapella.fcore#LogicalName=org.polarsys.capella.docgen.sections.display.BuletteListFromStringCollection" args="involvingFunctionalChains:parameterListParameter, projectNameParameter:projectNameParameter, outputFolderParameter:outputFolderParameter, title:sectionTitleParameter, level:sectionLevelParameter"%>
				...
				callParameters.put("parameterListParameter", involvingFunctionalChains);
