...
package org.polarsys.capella.docgen.sections.template;
...
public class templatePattern {
	...
	public static synchronized templatePattern create(String lineSeparator) {
		nl = lineSeparator;
		templatePattern result = new templatePattern();
		nl = null;
		return result;
	}
	...
	protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		//	Integer level = 2;
		// <%@ egf:patternCall patternId="platform:/plugin/org.polarsys.capella.docgen/egf/HTMLDocGenCapella.fcore#LogicalName=org.polarsys.capella.docgen.sections.display.BuletteList" args="allocatingComponents:parameterListParameter, projectNameParameter:projectNameParameter, outputFolderParameter:outputFolderParameter, title:sectionTitleParameter, level:sectionLevelParameter"
