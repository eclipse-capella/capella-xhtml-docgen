...
public class AbstractFunction_OutgoingFunctionalPorts {
	protected static String nl;

	public static synchronized AbstractFunction_OutgoingFunctionalPorts create(String lineSeparator) {
		nl = lineSeparator;
		AbstractFunction_OutgoingFunctionalPorts result = new AbstractFunction_OutgoingFunctionalPorts();
		nl = null;
		return result;
	}
	...
	public AbstractFunction_OutgoingFunctionalPorts() {
	...
	protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		EList<OutputPin> outgoingPorts = parameter.getOutputs();
		if (outgoingPorts.size() > 0) {
			String title = "Outgoing Functional Ports";
			Integer level = 2;

			stringBuffer.append(TEXT_1);
			{
				//<%@ egf:patternCall patternId="platform:/plugin/org.polarsys.capella.docgen/egf/HTMLDocGenCapella.fcore#LogicalName=org.polarsys.capella.docgen.sections.display.BuletteListFromEList" args="outgoingPorts:parameterListParameter, projectNameParameter:projectNameParameter, outputFolderParameter:outputFolderParameter, title:sectionTitleParameter, level:sectionLevelParameter"%>
				...
				callParameters.put("parameterListParameter", outgoingPorts);
