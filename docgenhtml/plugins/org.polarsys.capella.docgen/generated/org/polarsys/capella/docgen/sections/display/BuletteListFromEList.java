...
public class BuletteListFromEList extends org.polarsys.capella.docgen.sections.display.TitleSection {
	protected static String nl;

	public static synchronized BuletteListFromEList create(String lineSeparator) {
		nl = lineSeparator;
		BuletteListFromEList result = new BuletteListFromEList();
		nl = null;
		return result;
	}
				...
				for (Object parameterListParameterParameter : parameterListParameterList) {
					for (Object sectionTitleParameterParameter : sectionTitleParameterList) {
						for (Object sectionLevelParameterParameter : sectionLevelParameterList) {
							...
							this.parameterListParameter = (org.eclipse.emf.common.util.EList) parameterListParameterParameter;
	...
	protected org.eclipse.emf.common.util.EList parameterListParameter = null;

	public void set_parameterListParameter(org.eclipse.emf.common.util.EList object) {
	...
	protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		stringBuffer.append(
				StringUtil.stringListToBulette(parameterListParameter, projectNameParameter, outputFolderParameter));
