...
public class Region_ModesAndStates {
	protected static String nl;

	public static synchronized Region_ModesAndStates create(String lineSeparator) {
		nl = lineSeparator;
		Region_ModesAndStates result = new Region_ModesAndStates();
		nl = null;
		return result;
	}
	...
	protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		Collection<String> states = RegionHelper.getState(projectNameParameter, outputFolderParameter, parameter);
		if (states.size() > 0) {
			...
			stringBuffer.append(TEXT_1);
			{
				...
				callParameters.put("parameterListParameter", states);
