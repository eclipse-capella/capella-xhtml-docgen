...
public class Class_DataValues {
	protected static String nl;

	public static synchronized Class_DataValues create(String lineSeparator) {
		nl = lineSeparator;
		Class_DataValues result = new Class_DataValues();
		nl = null;
		return result;
	}
	...
	protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		Collection<String> dataValuesCollection = CapellaClassServices.getClassDataValues(parameter,
				projectNameParameter, outputFolderParameter);
		if (dataValuesCollection.size() > 0) {
			...
			stringBuffer.append(TEXT_2);
			{
				...
				callParameters.put("parameterListParameter", dataValuesCollection);
