...
public class Class_ReferencedBy {
	protected static String nl;

	public static synchronized Class_ReferencedBy create(String lineSeparator) {
		nl = lineSeparator;
		Class_ReferencedBy result = new Class_ReferencedBy();
		nl = null;
		return result;
	}
	...
	protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		Collection<String> referencedByCollection = CapellaClassServices.getReferencedBy(parameter,
				projectNameParameter, outputFolderParameter);
		if (referencedByCollection.size() > 0) {
			String title = "Referenced By";
			Integer level = 2;
			...
			stringBuffer.append(TEXT_1);
			{
				...
				callParameters.put("parameterListParameter", referencedByCollection);
