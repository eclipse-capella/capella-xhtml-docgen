...
public class Capability_ModesAndStates {
	protected static String nl;

	public static synchronized Capability_ModesAndStates create(String lineSeparator) {
		nl = lineSeparator;
		Capability_ModesAndStates result = new Capability_ModesAndStates();
		nl = null;
		return result;
	}
	...
	public Capability_ModesAndStates() {
