...
public class AbstractFunction_OutgoingInternalInteractions {
	protected static String nl;

	public static synchronized AbstractFunction_OutgoingInternalInteractions create(String lineSeparator) {
		nl = lineSeparator;
		AbstractFunction_OutgoingInternalInteractions result = new AbstractFunction_OutgoingInternalInteractions();
		nl = null;
		return result;
	}
	...
	public AbstractFunction_OutgoingInternalInteractions() {
	...
	protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		if (outgoingInternalInteractions.size() > 0) {
			String title = "Outgoing Internal Interactions";
			Integer level = 2;
			String[] columns = { "Interaction", "Involving Operational Processes", "Source", "Target", "Description",
					"Allocated Exchange Items", "Realized Functional Exchange", "Realizing Functional Exchange" };
