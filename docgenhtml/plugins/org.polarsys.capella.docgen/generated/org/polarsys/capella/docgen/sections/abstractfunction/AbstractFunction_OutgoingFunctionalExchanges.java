...
public class AbstractFunction_OutgoingFunctionalExchanges {
	protected static String nl;

	public static synchronized AbstractFunction_OutgoingFunctionalExchanges create(String lineSeparator) {
		nl = lineSeparator;
		AbstractFunction_OutgoingFunctionalExchanges result = new AbstractFunction_OutgoingFunctionalExchanges();
		nl = null;
		return result;
	}
	...
	public AbstractFunction_OutgoingFunctionalExchanges() {
	...
	protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		if (outgoingFunctionalExchanges.size() > 0) {
			String title = "Outgoing Functional Exchanges";
			Integer level = 2;
			String[] columns = { "Exchange", "Involving functional chains", "Allocating component Exchanges",
					"Distant Port", "Target", "Description", "Allocated Exchange Items", "Realized Functional Exchange",
