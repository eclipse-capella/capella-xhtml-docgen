...
public class ComponentContentDocGen {
  ...
  protected final String TEXT_9 = NL + "<h2>Incoming Component Exchanges</h2>" + NL + "<table>" + NL + "\t<tr>" + NL
      ...
      + "\t\t<th>Realized Component Exchanges</th>" + NL + "\t\t<th>Realizing Component Exchanges</th>" + NL + "\t</tr>"
      + NL + "\t";
  ...
  protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
    ...
    Collection<String> implementedInterfaces = CapellaComponentServices.getImplementedInterfaces((Component) element,
