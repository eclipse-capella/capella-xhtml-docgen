...
public class Class_Features {
	protected static String nl;

	public static synchronized Class_Features create(String lineSeparator) {
		nl = lineSeparator;
		Class_Features result = new Class_Features();
		nl = null;
		return result;
	}
	...
	protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		Collection<String> features = CapellaClassServices.getClassFeatures(parameter);
		if (features.size() > 0) {
			...
			stringBuffer.append(TEXT_2);
			{
				...
				callParameters.put("parameterListParameter", features);
