...
public class AbstractFunction_ModesAndStates {
	protected static String nl;

	public static synchronized AbstractFunction_ModesAndStates create(String lineSeparator) {
		nl = lineSeparator;
		AbstractFunction_ModesAndStates result = new AbstractFunction_ModesAndStates();
		nl = null;
		return result;
	}
	...
	public AbstractFunction_ModesAndStates() {
	...
	protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		Collection<String> availableModeAndState = CapellaFunctionServices
				.getAvailableModeAndState(projectNameParameter, outputFolderParameter, parameter);

		if (availableModeAndState.size() > 0) {
			String title = "Modes and States";
			Integer level = 2;

			stringBuffer.append(TEXT_1);
			{
				//<%@ egf:patternCall patternId="platform:/plugin/org.polarsys.capella.docgen/egf/HTMLDocGenCapella.fcore#LogicalName=org.polarsys.capella.docgen.sections.display.BuletteListFromStringCollection" args="availableModeAndState:parameterListParameter, projectNameParameter:projectNameParameter, outputFolderParameter:outputFolderParameter, title:sectionTitleParameter, level:sectionLevelParameter"%>
				...
				callParameters.put("parameterListParameter", availableModeAndState);
