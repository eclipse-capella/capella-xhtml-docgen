...
public class AbstractFunction_OutgoingInteractions {
	protected static String nl;

	public static synchronized AbstractFunction_OutgoingInteractions create(String lineSeparator) {
		nl = lineSeparator;
		AbstractFunction_OutgoingInteractions result = new AbstractFunction_OutgoingInteractions();
		nl = null;
		return result;
	}
	...
	public AbstractFunction_OutgoingInteractions() {
	...
	protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		Collection<FunctionalExchange> outgoingInteractions = CapellaFunctionServices
				.getOutgoingFunctionalExchanges(parameter);
		if (outgoingInteractions.size() > 0) {
			String title = "Outgoing Interactions";
			Integer level = 2;
			String[] columns = { "Interaction", "Target", "Description", "Allocated Exchange Items" };
			...
			for (FunctionalExchange activityEdge : outgoingInteractions) {

				stringBuffer.append(TEXT_2);
				stringBuffer.append(CapellaFunctionServices.outgoingInteractionToTableLine(activityEdge,
