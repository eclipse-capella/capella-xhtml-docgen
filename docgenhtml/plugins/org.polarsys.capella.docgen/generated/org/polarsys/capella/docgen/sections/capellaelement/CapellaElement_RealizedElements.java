...
public class CapellaElement_RealizedElements {
	protected static String nl;

	public static synchronized CapellaElement_RealizedElements create(String lineSeparator) {
		nl = lineSeparator;
		CapellaElement_RealizedElements result = new CapellaElement_RealizedElements();
		nl = null;
		return result;
	}
	...
	public CapellaElement_RealizedElements() {
	...
	protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		Collection<String> allocations = CapellaElementService.getOutGoingAllocation(parameter, projectName,
				outputFolder);
		if (allocations.size() > 0) {
			String title = "Realized Elements";
			Integer level = 2;
