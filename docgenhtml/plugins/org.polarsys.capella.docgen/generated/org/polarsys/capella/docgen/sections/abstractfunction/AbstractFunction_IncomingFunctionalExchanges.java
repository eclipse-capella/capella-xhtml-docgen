...
public class AbstractFunction_IncomingFunctionalExchanges {
	protected static String nl;

	public static synchronized AbstractFunction_IncomingFunctionalExchanges create(String lineSeparator) {
		nl = lineSeparator;
		AbstractFunction_IncomingFunctionalExchanges result = new AbstractFunction_IncomingFunctionalExchanges();
		nl = null;
		return result;
	}
	...
	public AbstractFunction_IncomingFunctionalExchanges() {
	...
	protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		if (incomingFunctionalExchanges.size() > 0) {
			String title = "Incoming Functional Exchanges";
			Integer level = 2;
			String[] columns = { "Exchange", "Involving functional chains", "Allocating component Exchanges",
					"Distant Port", "Source", "Description", "Allocated Exchange Items", "Realized Functional Exchange",
