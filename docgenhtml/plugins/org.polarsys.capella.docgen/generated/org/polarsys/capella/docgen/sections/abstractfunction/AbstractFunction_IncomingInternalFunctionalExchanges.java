...
public class AbstractFunction_IncomingInternalFunctionalExchanges {
	protected static String nl;

	public static synchronized AbstractFunction_IncomingInternalFunctionalExchanges create(String lineSeparator) {
		nl = lineSeparator;
		AbstractFunction_IncomingInternalFunctionalExchanges result = new AbstractFunction_IncomingInternalFunctionalExchanges();
		nl = null;
		return result;
	}
	...
	public AbstractFunction_IncomingInternalFunctionalExchanges() {
	...
	protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		Collection<FunctionalExchange> incomingInternalFunctionalExchanges = CapellaFunctionServices
				.getIncomingInternalFunctionalExchanges(parameter);
		if (incomingInternalFunctionalExchanges.size() > 0) {
			String title = "Incoming Internal Functional Exchanges";
			Integer level = 2;
