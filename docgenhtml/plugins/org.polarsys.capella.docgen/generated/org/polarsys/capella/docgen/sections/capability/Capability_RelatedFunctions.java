...
public class Capability_RelatedFunctions {
	protected static String nl;

	public static synchronized Capability_RelatedFunctions create(String lineSeparator) {
		nl = lineSeparator;
		Capability_RelatedFunctions result = new Capability_RelatedFunctions();
		nl = null;
		return result;
	}
	...
	public Capability_RelatedFunctions() {
