...
public class indexBuilder extends org.polarsys.kitalpha.doc.gen.business.core.index.IndexBuilder {
  ...
  protected final String TEXT_1 = "  <script type=\"text/javascript\">" + NL
      ...
      + "var anchorText = \"\";" + NL + "if (location.search) {" + NL + "\tlocationText = location.search.substring(1);"
      + NL + "\tif (location.href.lastIndexOf(\"#\")>0) {" + NL
  ...
  protected final String TEXT_2 = "\";" + NL + "}" + NL
      ...
      + NL + "document.write('<noframes>');" + NL + "document.write('Your browser cannot display this page !');" + NL
