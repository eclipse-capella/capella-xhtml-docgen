...
public class AbstractFunction_InvolvingFunctionalChains {
	...
	public static synchronized AbstractFunction_InvolvingFunctionalChains create(String lineSeparator) {
		nl = lineSeparator;
		AbstractFunction_InvolvingFunctionalChains result = new AbstractFunction_InvolvingFunctionalChains();
		nl = null;
		return result;
	}
	...
	public AbstractFunction_InvolvingFunctionalChains() {
	...
	protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		if (involvingFunctionalChains.size() > 0) {
			String title = "Involving Functional Chains";
			Integer level = 2;
