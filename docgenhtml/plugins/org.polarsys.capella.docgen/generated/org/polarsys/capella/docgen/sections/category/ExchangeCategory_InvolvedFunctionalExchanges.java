...
public class ExchangeCategory_InvolvedFunctionalExchanges {
	protected static String nl;

	public static synchronized ExchangeCategory_InvolvedFunctionalExchanges create(String lineSeparator) {
		nl = lineSeparator;
		ExchangeCategory_InvolvedFunctionalExchanges result = new ExchangeCategory_InvolvedFunctionalExchanges();
		nl = null;
		return result;
	}
	...
	public ExchangeCategory_InvolvedFunctionalExchanges() {
		...
		for (Object parameterParameter : parameterList) {
			for (Object projectNameParameterParameter : projectNameParameterList) {
				for (Object outputFolderParameterParameter : outputFolderParameterList) {
					...
					this.parameter = (org.polarsys.capella.core.data.fa.ExchangeCategory) parameterParameter;
	...
	protected org.polarsys.capella.core.data.fa.ExchangeCategory parameter = null;

	public void set_parameter(org.polarsys.capella.core.data.fa.ExchangeCategory object) {
	...
	protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		if (parameter.getExchanges().size() > 0) {
			String title = "Involved Functional Exchanges";
			Integer level = 2;
			String[] columns = { "Functional Exchange", "Source Function", "Target Function", "Description" };
			...
			for (FunctionalExchange fe : parameter.getExchanges()) {

				stringBuffer.append(TEXT_2);
				stringBuffer.append(
						CapellaCategoryServices.edgeToTableLine(fe, projectNameParameter, outputFolderParameter));
				stringBuffer.append(TEXT_2);
	...
	public boolean preCondition(PatternContext ctx) throws Exception {
		return parameter instanceof ExchangeCategory;
	}
}