...
public class AbstractFunction_IncomingInternalInteractions {
	protected static String nl;

	public static synchronized AbstractFunction_IncomingInternalInteractions create(String lineSeparator) {
		nl = lineSeparator;
		AbstractFunction_IncomingInternalInteractions result = new AbstractFunction_IncomingInternalInteractions();
		nl = null;
		return result;
	}
	...
	public AbstractFunction_IncomingInternalInteractions() {
	...
	protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		if (incomingInternalInteractions.size() > 0) {
			String title = "Incoming Internal Interactions";
			Integer level = 2;
