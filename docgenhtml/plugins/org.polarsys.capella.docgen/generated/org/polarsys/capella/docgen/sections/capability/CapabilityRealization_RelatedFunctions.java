...
public class CapabilityRealization_RelatedFunctions {
	protected static String nl;

	public static synchronized CapabilityRealization_RelatedFunctions create(String lineSeparator) {
		nl = lineSeparator;
		CapabilityRealization_RelatedFunctions result = new CapabilityRealization_RelatedFunctions();
		nl = null;
		return result;
	}
	...
	public CapabilityRealization_RelatedFunctions() {
	...
	protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		Collection<String> involvedFunctions = CapellaCapabilityHelper.INSTANCE
				.getInvolvedFunctions(projectNameParameter, outputFolderParameter, parameter);
		if (involvedFunctions.size() > 0) {
			String title = "Related Functions";
			Integer level = 2;

			stringBuffer.append(TEXT_1);
			{
				//<%@ egf:patternCall patternId="platform:/plugin/org.polarsys.capella.docgen/egf/HTMLDocGenCapella.fcore#LogicalName=org.polarsys.capella.docgen.sections.display.BuletteListFromStringCollection" args="involvedFunctions:parameterListParameter, projectNameParameter:projectNameParameter, outputFolderParameter:outputFolderParameter, title:sectionTitleParameter, level:sectionLevelParameter"%>
				...
				callParameters.put("parameterListParameter", involvedFunctions);
