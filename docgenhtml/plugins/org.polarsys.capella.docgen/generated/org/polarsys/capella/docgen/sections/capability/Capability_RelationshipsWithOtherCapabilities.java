...
public class Capability_RelationshipsWithOtherCapabilities {
	protected static String nl;

	public static synchronized Capability_RelationshipsWithOtherCapabilities create(String lineSeparator) {
		nl = lineSeparator;
		Capability_RelationshipsWithOtherCapabilities result = new Capability_RelationshipsWithOtherCapabilities();
		nl = null;
		return result;
	}
	...
	public Capability_RelationshipsWithOtherCapabilities() {
	...
	protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		Collection<String> extendedCapabilities = CapellaCapabilityHelper.INSTANCE
				.getExtendedCapabilities(projectNameParameter, outputFolderParameter, parameter);
		Collection<String> includedCapabilities = CapellaCapabilityHelper.INSTANCE
				.getIncludedCapabilities(projectNameParameter, outputFolderParameter, parameter);
		Collection<String> superCapabilities = CapellaCapabilityHelper.INSTANCE
				.getParentCapabilities(projectNameParameter, outputFolderParameter, parameter);
		if ((extendedCapabilities.size() > 0) || (includedCapabilities.size() > 0) || (superCapabilities.size() > 0)) {
			String title = "Relationships with other Capabilities";
			Integer level = 2;

			stringBuffer.append(TEXT_1);
			{
				//<%@ egf:patternCall patternId="platform:/plugin/org.polarsys.capella.docgen/egf/HTMLDocGenCapella.fcore#LogicalName=org.polarsys.capella.docgen.sections.display.TitleSection" args="title:sectionTitleParameter, level:sectionLevelParameter"%>
			...
			if (extendedCapabilities.size() > 0) {
				...
				stringBuffer.append(TEXT_2);
				{
					//<%@ egf:patternCall patternId="platform:/plugin/org.polarsys.capella.docgen/egf/HTMLDocGenCapella.fcore#LogicalName=org.polarsys.capella.docgen.sections.display.BuletteListFromStringCollection" args="extendedCapabilities:parameterListParameter, projectNameParameter:projectNameParameter, outputFolderParameter:outputFolderParameter, title:sectionTitleParameter, level:sectionLevelParameter"%>
					...
					final Map<String, Object> callParameters = new HashMap<String, Object>();
					callParameters.put("parameterListParameter", extendedCapabilities);
			...
			if (includedCapabilities.size() > 0) {
				...
				stringBuffer.append(TEXT_2);
				{
					//<%@ egf:patternCall patternId="platform:/plugin/org.polarsys.capella.docgen/egf/HTMLDocGenCapella.fcore#LogicalName=org.polarsys.capella.docgen.sections.display.BuletteListFromStringCollection" args="includedCapabilities:parameterListParameter, projectNameParameter:projectNameParameter, outputFolderParameter:outputFolderParameter, title:sectionTitleParameter, level:sectionLevelParameter"%>
					...
					final Map<String, Object> callParameters = new HashMap<String, Object>();
					callParameters.put("parameterListParameter", includedCapabilities);
					callParameters.put("projectNameParameter", projectNameParameter);
					callParameters.put("outputFolderParameter", outputFolderParameter);
					callParameters.put("sectionTitleParameter", title);
					callParameters.put("sectionLevelParameter", level);
			...
			if (superCapabilities.size() > 0) {
				...
				stringBuffer.append(TEXT_2);
				{
					...
					final Map<String, Object> callParameters = new HashMap<String, Object>();
					callParameters.put("parameterListParameter", superCapabilities);
					callParameters.put("projectNameParameter", projectNameParameter);
					callParameters.put("outputFolderParameter", outputFolderParameter);
					callParameters.put("sectionTitleParameter", title);
					callParameters.put("sectionLevelParameter", level);
