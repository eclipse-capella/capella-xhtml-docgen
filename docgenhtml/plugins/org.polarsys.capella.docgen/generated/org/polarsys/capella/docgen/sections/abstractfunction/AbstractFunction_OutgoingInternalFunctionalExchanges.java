...
public class AbstractFunction_OutgoingInternalFunctionalExchanges {
	protected static String nl;

	public static synchronized AbstractFunction_OutgoingInternalFunctionalExchanges create(String lineSeparator) {
		nl = lineSeparator;
		AbstractFunction_OutgoingInternalFunctionalExchanges result = new AbstractFunction_OutgoingInternalFunctionalExchanges();
		nl = null;
		return result;
	}
	...
	public AbstractFunction_OutgoingInternalFunctionalExchanges() {
	...
	protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		Collection<FunctionalExchange> outgoingInternalFunctionalExchanges = CapellaFunctionServices
				.getOutgoingInternalFunctionalExchanges(parameter);
		if (outgoingInternalFunctionalExchanges.size() > 0) {
			String title = "Outgoing Internal Functional Exchanges";
			Integer level = 2;
			String[] columns = { "Exchange", "Involving functional chains", "Allocating component Exchanges",
					"Distant Port", "Source", "Target", "Description", "Allocated Exchange Items",
					"Realized Functional Exchange", "Realizing Functional Exchange" };
