...
public class PhysicalLinkCategory_InvolvedPhysicalLinks {
	protected static String nl;

	public static synchronized PhysicalLinkCategory_InvolvedPhysicalLinks create(String lineSeparator) {
		nl = lineSeparator;
		PhysicalLinkCategory_InvolvedPhysicalLinks result = new PhysicalLinkCategory_InvolvedPhysicalLinks();
		nl = null;
		return result;
	}
	...
	public PhysicalLinkCategory_InvolvedPhysicalLinks() {
		...
		for (Object parameterParameter : parameterList) {
			for (Object projectNameParameterParameter : projectNameParameterList) {
				for (Object outputFolderParameterParameter : outputFolderParameterList) {
					...
					this.parameter = (org.polarsys.capella.core.data.cs.PhysicalLinkCategory) parameterParameter;
	...
	protected org.polarsys.capella.core.data.cs.PhysicalLinkCategory parameter = null;

	public void set_parameter(org.polarsys.capella.core.data.cs.PhysicalLinkCategory object) {
	...
	protected void method_body(final StringBuffer stringBuffer, final PatternContext ctx) throws Exception {
		...
		if (parameter.getLinks().size() > 0) {
			String title = "Involved Physical Links";
			Integer level = 2;
			String[] columns = { "Physical Link", "Source Component", "Target Component", "Description" };
			...
			for (PhysicalLink pl : parameter.getLinks()) {

				stringBuffer.append(TEXT_2);
				stringBuffer.append(
						CapellaCategoryServices.edgeToTableLine(pl, projectNameParameter, outputFolderParameter));
				stringBuffer.append(TEXT_2);
	...
	public boolean preCondition(PatternContext ctx) throws Exception {
		return parameter instanceof PhysicalLinkCategory;
	}
}