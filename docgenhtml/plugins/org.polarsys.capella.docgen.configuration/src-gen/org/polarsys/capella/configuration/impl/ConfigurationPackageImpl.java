...
public class ConfigurationPackageImpl extends EPackageImpl implements ConfigurationPackage {
	 ...
	 * @see org.polarsys.capella.configuration.ConfigurationPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public void createPackageContents() {
		...
		createEReference(configurationEClass, CONFIGURATION__CONFIGURATION_ELEMENTS);

		configurationElementEClass = createEClass(CONFIGURATION_ELEMENT);
		createEReference(configurationElementEClass, CONFIGURATION_ELEMENT__REFERENCE);
	}
	...
	public void initializePackageContents() {
		...
		initEReference(getConfiguration_ConfigurationElements(), this.getConfigurationElement(), null, "configurationElements", null, 0, -1, Configuration.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEReference(getConfigurationElement_Reference(), ecorePackage.getEObject(), null, "reference", null, 1, 1, ConfigurationElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
